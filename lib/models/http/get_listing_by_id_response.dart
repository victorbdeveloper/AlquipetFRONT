...
//
//     final getListingByIdResponse = getListingByIdResponseFromMap(jsonString);

import 'dart:convert';

class GetListingByIdResponse {
  ...
  factory GetListingByIdResponse.fromJson(String str) =>
      GetListingByIdResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetListingByIdResponse.fromMap(Map<String, dynamic> json) =>
      GetListingByIdResponse(
        msg: json["msg"],
  ...
  @override
  String toString() {
    return 'GetListingByIdResponse{msg: $msg, listing: $listing}';
  }
}
