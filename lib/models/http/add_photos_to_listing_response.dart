...
//
//     final addPhotosToListingResponse = addPhotosToListingResponseFromMap(jsonString);

import 'dart:convert';

class AddPhotosToListingResponse {
  AddPhotosToListingResponse({
    required this.msg,
  ...
  factory AddPhotosToListingResponse.fromJson(String str) =>
      AddPhotosToListingResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AddPhotosToListingResponse.fromMap(Map<String, dynamic> json) =>
      AddPhotosToListingResponse(
        msg: json["msg"],
  ...
  @override
  String toString() {
    return 'AddPhotosToListingResponse{msg: $msg, listing: $listing}';
  }
}
