...
//
//     final deletePhotosToListingResponse = deletePhotosToListingResponseFromMap(jsonString);

import 'dart:convert';

class DeletePhotosToListingResponse {
  DeletePhotosToListingResponse({
    required this.msg,
  ...
  factory DeletePhotosToListingResponse.fromJson(String str) =>
      DeletePhotosToListingResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DeletePhotosToListingResponse.fromMap(Map<String, dynamic> json) =>
      DeletePhotosToListingResponse(
        msg: json["msg"],
  ...
  @override
  String toString() {
    return 'DeletePhotosToListingResponse{msg: $msg, listing: $listing}';
  }
}
