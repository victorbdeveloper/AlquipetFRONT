...
//
//     final getFilteredListingsPaginatedResponse = getFilteredListingsPaginatedResponseFromMap(jsonString);

import 'dart:convert';

class GetFilteredListingsPaginatedResponse {
  ...
  factory GetFilteredListingsPaginatedResponse.fromJson(String str) =>
      GetFilteredListingsPaginatedResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetFilteredListingsPaginatedResponse.fromMap(
