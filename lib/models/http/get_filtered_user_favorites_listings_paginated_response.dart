...
//
//     final getFilteredUserFavoritesListingsPaginatedResponse = getFilteredUserFavoritesListingsPaginatedResponseFromMap(jsonString);

import 'dart:convert';

class GetFilteredUserFavoritesListingsPaginatedResponse {
  GetFilteredUserFavoritesListingsPaginatedResponse({
  ...
  factory GetFilteredUserFavoritesListingsPaginatedResponse.fromJson(
          String str) =>
      GetFilteredUserFavoritesListingsPaginatedResponse.fromMap(
          json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetFilteredUserFavoritesListingsPaginatedResponse.fromMap(
...
class Result {
  ...
  @override
  String toString() {
    return 'Result{createdBy: $createdBy, state: $state, address: $address, petsAllowed: $petsAllowed, photos: $photos, price: $price, datePublication: $datePublication, uid: $uid}';
  }
}
