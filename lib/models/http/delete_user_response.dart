...
//
//     final deleteUserResponse = deleteUserResponseFromMap(jsonString);
...
class DeleteUserResponse {
  ...
  factory DeleteUserResponse.fromJson(String str) =>
      DeleteUserResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory DeleteUserResponse.fromMap(Map<String, dynamic> json) =>
      DeleteUserResponse(
        msg: json["msg"],
  ...
  @override
  String toString() {
    return 'DeleteUserResponse{msg: $msg, user: $user}';
  }
}
