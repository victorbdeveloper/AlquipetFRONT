...
class _HomeFiltersState extends State<HomeFilters> {
  ...
  void initState() {
    ...
    homeProvider.priceMin != null ? priceMinController.text = homeProvider.priceMin.toString() : priceMinController.text = "";
    homeProvider.priceMax != null ? priceMaxController.text = homeProvider.priceMax.toString() : priceMaxController.text = "";
    super.initState();
  }
                ...
                child: Column(
                  ...
                  children: <Widget>[
                          ...
                          children: <Widget>[
                            ...
                            ElevatedButton(
                              onPressed: () {
                                ...
                                homeProvider.isLoading = true;
                                homeProvider.update(<String>["homePageContent","popupMenuItem"]);
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) => {homeProvider.priceMin = int.tryParse(value)},
                              ),
                            ),
                          ),
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) => {homeProvider.priceMax = int.tryParse(value)},
                              ),
                            ),
                          ),
                        ],
                    ...
                    DropdownButton<String>(
                        ...
                        value: orderByTitle[orderByValue.indexOf(homeProvider.orderBy)],
                        ...
                        onChanged: (newVal) {
                          homeProvider.orderBy = orderByValue[orderByTitle.indexOf(newVal!)];
                                ...
                                children: <Widget>[
                                  ...
                                  CheckboxListTile(
                                    ...
                                    onChanged: (newValue) {
                                      setState(() {
                                        homeProvider.dogs = newValue!;
                                        homeProvider.update(["popupMenuItem"]);
                                      });
                                    },
                                    controlAffinity: ListTileControlAffinity.leading, //  <-- leading Checkbox
                                  ),
